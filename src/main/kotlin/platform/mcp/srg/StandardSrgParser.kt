...
object StandardSrgParser : SrgParser {
    override fun parseSrg(path: Path): Mappings {
        ...
        val classes = hashSetOf<Pair<String, String>>()
        val fields = hashSetOf<Pair<MemberReference, MemberReference>>()
        val methods = hashSetOf<Pair<MemberReference, MemberReference>>()
